...
export async function addExtensionDarwin(
  ...
  await utils.asyncForEach(extensions, async function (extension: string) {
    ...
    switch (true) {
      ...
      case /(?<!5\.[3-5])(amqp|apcu|brotli|expect|gmagick|gnupg|grpc|igbinary|imagick|imap|mailparse|mcrypt|memcache|memcached|mongodb|mongodb1|msgpack|newrelic|opentelemetry|pinba|protobuf|psr|raphf|rdkafka|redis|scalar_objects|snmp|spx|ssh2|swoole|uuid|vld|xdebug|xdebug2|xhprof|yaml|zmq|zstd)/.test(
        version_extension
      ):
